...
CREATE TABLE growth_leads (
  ...
  referrer_tenant_id BIGINT NULL,            -- 来源名片所属企业，仅平台可见
  referrer_card_id BIGINT NULL,
  referrer_member_identity_id BIGINT NULL,
  share_id VARCHAR(64) NULL,                 -- 转介绍归因
  visitor_account_id BIGINT NULL,
  contact_name VARCHAR(128) NULL,
  contact_phone_encrypted TEXT NULL,
  contact_company VARCHAR(255) NULL,
  intent VARCHAR(64) NULL DEFAULT 'want_own_card',
  status VARCHAR(32) NOT NULL DEFAULT 'new', -- new / contacted / converted / dropped
  created_at DATETIME NOT NULL,
  updated_at DATETIME NOT NULL,
  KEY idx_lead_referrer (referrer_tenant_id, referrer_card_id),
