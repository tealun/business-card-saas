...
process.env.WECOM_LOGIN_SUITE_ID = "wwtestloginsuiteid";
process.env.WECOM_LOGIN_SUITE_SECRET = "test-login-suite-secret";
process.env.WECOM_LOGIN_CALLBACK_TOKEN = "test-login-callback-token";
process.env.WECOM_LOGIN_CALLBACK_AES_KEY = "abcdefghijklmnopqrstuvwxyz0123456789ABCDEFG";
