...
import { acceptMemberInvitationSchema, createLocalEnterpriseSchema, createMemberInvitationSchema, reviewJoinRequestSchema, submitJoinRequestSchema } from "../contracts/local-enterprise.js";
...
export class LocalEnterpriseController {
  ...
  @Post() create(@Req() req: EmployeeRequest, @Body() body: unknown) { const input=createLocalEnterpriseSchema.parse(body); return this.service.create(req.employeeSession!, input.name); }
